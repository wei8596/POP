/*
pointer to long linked list functions
*/
#include "list_ptr_to_long.h"

//  Add a node forward
void addNodeForward(Node** pHead, long* data) {
...
void addNodeReverse(Node** pHead, long* data) {
    Node* pNode = (Node*)mymalloc(sizeof(Node));
...
//  Delete nodes
void deleteNode(Node** pHead, long* Searchdata) {
    int Nodefound = 0;
    Node* pCurrent =  *pHead;
    if (pCurrent != NULL) {
