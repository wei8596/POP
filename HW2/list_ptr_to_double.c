/*
pointer to double linked list functions
*/
#include "list_ptr_to_double.h"

//  Add a node forward
void addNodeForward(Node** pHead, double* data) {
...
void addNodeReverse(Node** pHead, double* data) {
    Node* pNode = (Node*)mymalloc(sizeof(Node));
...
//  Delete nodes
void deleteNode(Node** pHead, double* Searchdata) {
    int Nodefound = 0;
    Node* pCurrent =  *pHead;
    if (pCurrent != NULL) {
