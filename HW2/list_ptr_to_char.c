/*
pointer to char linked list functions
*/
#include "list_ptr_to_char.h"

//  Add a node forward
void addNodeForward(Node** pHead, char* data) {
...
void addNodeReverse(Node** pHead, char* data) {
    Node* pNode = (Node*)mymalloc(sizeof(Node));
...
//  Delete nodes
void deleteNode(Node** pHead, char* Searchdata) {
    int Nodefound = 0;
    Node* pCurrent =  *pHead;
    if (pCurrent != NULL) {
