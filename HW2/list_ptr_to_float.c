/*
pointer to float linked list functions
*/
#include "list_ptr_to_float.h"

//  Add a node forward
void addNodeForward(Node** pHead, float* data) {
...
void addNodeReverse(Node** pHead, float* data) {
    Node* pNode = (Node*)mymalloc(sizeof(Node));
...
//  Delete nodes
void deleteNode(Node** pHead, float* Searchdata) {
    int Nodefound = 0;
    Node* pCurrent =  *pHead;
    if (pCurrent != NULL) {
