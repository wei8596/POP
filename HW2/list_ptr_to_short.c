/*
pointer to short linked list functions
*/
#include "list_ptr_to_short.h"

//  Add a node forward
void addNodeForward(Node** pHead, short* data) {
...
void addNodeReverse(Node** pHead, short* data) {
    Node* pNode = (Node*)mymalloc(sizeof(Node));
...
//  Delete nodes
void deleteNode(Node** pHead, short* Searchdata) {
    int Nodefound = 0;
    Node* pCurrent =  *pHead;
    if (pCurrent != NULL) {
